export const environment = {
  production: true,
  redirectUrl: 'https://dev-bluebellplatform.azurewebsites.net',
  msalConfig: {
    auth: {
  ...
  apiConfig: {
    scopes: [
      'https://bbindex.onmicrosoft.com/f41870ef-c846-44b6-9bd0-ba579c6cca57/QueryToken',
    ],
    uri: 'https://dev-bluebellindex-bff.azurewebsites.net',
  },
  b2cPolicies: {
    names: {
